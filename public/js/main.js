...
var _NewsBroadcast = require('../../components/NewsBroadcast.vue');

var _NewsBroadcast2 = _interopRequireDefault(_NewsBroadcast);

var _Message = require('../../components/Message.vue');

var _Message2 = _interopRequireDefault(_Message);

var _Project = require('../../components/Project.vue');
...
router.map({
	...
	'/newsbroadcast': {
		component: _NewsBroadcast2.default
	},
...
router.start(_Layout2.default, '#app');

},{"../../components/Home.vue":8,"../../components/Layout.vue":9,"../../components/Message.vue":10,"../../components/NewsBroadcast.vue":11,"../../components/Project.vue":12,"vue":5,"vue-resource":3,"vue-router":4}],8:[function(require,module,exports){
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-abc31ec2", module.exports)
  } else {
    hotAPI.update("_v-abc31ec2", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-8bb6612c", module.exports)
  } else {
    hotAPI.update("_v-8bb6612c", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-3db73512", module.exports)
  } else {
    hotAPI.update("_v-3db73512", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-752159c4", module.exports)
  } else {
    hotAPI.update("_v-752159c4", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
   ...
   methods:
   {
   	newProject: function()
   	{
   		$('#addNewProject').openModal();   	}
   }
  }

if (module.exports.__esModule) module.exports = module.exports.default
;(typeof module.exports === "function"? module.exports.options: module.exports).template = "\n\n<div class=\"col s12\">\n\t<a class=\"waves-effect waves-light btn modal-trigger\" id=\"newProject\" v-on:click=\"newProject\">Add New Project</a>\n <div class=\"row\">\n\n      <div class=\"col s12 m4\">\n        <div class=\"card-panel white z-depth-2\">\n          some text\n        </div>\n      </div>\n\n      <div class=\"col s12 m4\">\n        <div class=\"card-panel white z-depth-2\">\n     \t\tsome text\n        </div>\n      </div>\n\n      <div class=\"col s12 m4\">\n        <div class=\"card-panel white z-depth-2\">\n          some text\n        </div>\n      </div>\n\n      <div class=\"col s12 m4\">\n        <div class=\"card-panel white z-depth-2\">\n          some text\n        </div>\n      </div>\n\n      <div class=\"col s12 m4\">\n        <div class=\"card-panel white z-depth-2\">\n          some text\n        </div>\n      </div>\n\n    </div>\n</div>\n\n\n\n\n<!-- Modal Structure -->\n<div id=\"addNewProject\" class=\"modal\">\n  <div class=\"modal-content\">\n    <h4>Modal Header</h4>\n    <p>A bunch of text</p>\n  </div>\n  <div class=\"modal-footer\">\n    <a href=\"#!\" @click.prevent=\"\" class=\" modal-action modal-close waves-effect waves-green btn-flat\">Agree</a>\n  </div>\n</div>\n\n\n\n\n\n\n"
if (module.hot) {(function () {  module.hot.accept()
  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-45ac50ee", module.exports)
  } else {
    hotAPI.update("_v-45ac50ee", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
